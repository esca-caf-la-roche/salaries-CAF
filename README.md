...
La page **Configuration** affiche aussi les calendriers d'origine effectivement rencontrés dans les événements synchronisés. Ils sont classés selon les quatre catégories de comptage — Heures du contrat, Heures d'absences, Heures de remplacements ou Heures fériées — puis selon leur niveau de préparation : coefficient 1 (sans préparation) ou 1,25 (avec préparation). La couleur du calendrier Google sert de repère visuel. Une catégorie ou un coefficient inconnu rejoint le groupe **À définir**, est signalé sur le tableau de bord administrateur et reste exclu des totaux afin d'éviter un calcul silencieusement faux.
