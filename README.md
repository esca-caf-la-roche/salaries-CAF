...
La page **Configuration** affiche aussi les calendriers d'origine effectivement rencontrés dans les événements synchronisés. L'administrateur choisit indépendamment, pour chacun, son coefficient 1 (sans préparation) ou 1,25 (avec préparation) et sa catégorie de comptage : Heures du contrat, Heures d'absences, Heures de remplacements ou Heures fériées. Une catégorie ou un coefficient inconnu reste **À définir**, est signalé sur le tableau de bord administrateur et reste exclu des totaux afin d'éviter un calcul silencieusement faux.
